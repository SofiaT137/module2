...
public interface GiftCertificateQueries {
    ...
    String GET_GIFT_CERTIFICATES = "SELECT gift_certificate_id, gift_certificate_name, description, price, duration, create_date, last_update_date FROM gift_certificate";
