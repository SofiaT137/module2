...
public final class GiftCertificateQueries {
    ...
    public static final String INSERT_GIFT_CERTIFICATE = "INSERT INTO gift_certificates(gift_certificate_name, description, price, duration, create_date,last_update_date) VALUES(?, ?, ?, ?, ?, ?)";
    public static final String ADD_CERTIFICATE_TAGS = "INSERT INTO gift_certificate_tag(gift_certificate_id, tag_id) VALUES(?, ?)";
    public static final String GET_GIFT_CERTIFICATE_BY_ID = "SELECT * FROM gift_certificates WHERE id=?";
    public static final String GET_GIFT_CERTIFICATES = "SELECT gc.id, gift_certificate_name, description, price, duration, create_date, last_update_date FROM gift_certificates AS gc ";
    ...
    public static final String JOIN_BY_TAG_ID = "INNER JOIN gift_certificate_tag AS gct ON gc.id = gct.gift_certificate_id INNER JOIN tags AS t on t.d = gct.tag_id";
